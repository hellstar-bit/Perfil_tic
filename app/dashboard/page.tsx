        ...
        {perfil ? (
          <div className="card p-6 max-w-lg">
            <div className="flex items-start justify-between gap-4 mb-6">
              <div>
                <p className="section-label mb-1">Tu perfil</p>
                <p className="text-lg font-bold text-ink-900">{perfil.nombre}</p>
          ...
          <div className="card p-8 max-w-lg text-center">
            <div className="w-14 h-14 rounded-full bg-brand-50 grid place-items-center mx-auto mb-4">
              <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="#00E5A0" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
                <circle cx="12" cy="8" r="4" />
                <path d="M4 20c0-4 3.6-7 8-7s8 3 8 7" />
              </svg>
            </div>
            <h2 className="text-lg font-bold text-ink-900 mb-1">Aún no tienes un perfil</h2>
